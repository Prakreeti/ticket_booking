...
ActiveRecord::Schema.define(version: 20161014081336) do
  ...
  add_index "blocked_seats", ["show_time_id"], name: "index_blocked_seats_on_show_time_id", using: :btree
  ...
  add_index "seat_selects", ["show_time_id"], name: "index_seat_selects_on_show_time_id", using: :btree
  ...
  add_foreign_key "blocked_seats", "show_times"
  ...
  add_foreign_key "seat_selects", "show_times"
